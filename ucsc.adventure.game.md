...
```
In article <S3f3.2587@looking.on.ca>, strange@cats.ucsc.edu writes:
...
Originally found on MIT but only accessible via Google Cache now
http://web.mit.edu/humor/Computers/ucsc.adventure.game

Retrieved 2020.06.30 by @nyxgeek
